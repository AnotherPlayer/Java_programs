...
public class Racional implements Comparable<Racional>{
    ...
    //Codigo implementar Racional    
    
    public int compare(Racional x){

        if((x.num*this.den) < (this.num*x.den))
            return 1;
    ...
    public int compare(Racional x, Racional y){
    ...
    @Override
    public int compareTo(Racional x){
